...
# Understanding high availability and disaster recovery for {{site.data.keyword.messages-for-rabbitmq-gen2}}
{: #rabbitmq-ha-dr}
...
{{site.data.keyword.messages-for-rabbitmq-gen2}} is a highly available regional service designed for availability during a regional outage. {{site.data.keyword.messages-for-rabbitmq-gen2}} is designed to meet the [Service Level Objectives (SLO)](/docs/resiliency?topic=resiliency-slo) with the Standard plan.
...
{{site.data.keyword.messages-for-rabbitmq-gen2}} supports the following high availability features:
...
{: caption="HA features for {{site.data.keyword.messages-for-rabbitmq-gen2}}" caption-side="bottom"}

## Disaster recovery architecture
{: #disaster-recovery-intro}

The general strategy for disaster recovery is to create a new {{site.data.keyword.messages-for-rabbitmq-gen2}} instance using the backup, and restore it to the same or another region.
...
{{site.data.keyword.messages-for-rabbitmq-gen2}} supports the following disaster recovery features:
...
{: caption="DR features for {{site.data.keyword.messages-for-rabbitmq-gen2}}" caption-side="bottom"}
...
| Zone failure | The {{site.data.keyword.messages-for-rabbitmq-gen2}} members are distributed between zones. Three members provide additional resiliency to multiple zone failures. |
...
{: caption="DR scenarios for {{site.data.keyword.messages-for-rabbitmq-gen2}}" caption-side="bottom"}

### Connection limits
{: #connection-limits}

It is important to prevent overwhelming your deployment with connections. If the number of connections to the database exceeds the connection limit, new connections fail and return an error. For more information {{site.data.keyword.messages-for-rabbitmq-gen2}}, see [Connection limits](/docs/messages-for-rabbitmq-gen2?topic=messages-for-rabbitmq-gen2-rabbitmq-ha-dr#connection-limits).
...
To find out more about responsibility ownership between the customer and IBM Cloud for using {{site.data.keyword.messages-for-rabbitmq-gen2}}, see [Shared responsibilities for Cloud Databases](/docs/cloud-databases?topic=cloud-databases-responsibilities-cloud-databases).
